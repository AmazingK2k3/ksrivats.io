...
import { Calendar, Tag, Search, Instagram } from "lucide-react";
          ...
          <div className="text-center mb-12">
            ...
            <div className="max-w-md mx-auto mb-8">
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                <p className="text-lg font-medium">More Creative Work</p>
              </div>
              <blockquote 
                className="instagram-media" 
                data-instgrm-captioned 
                data-instgrm-permalink="https://www.instagram.com/p/C9NkfzfyC6U/?utm_source=ig_embed&utm_campaign=loading" 
              ...
              >
                ...
                <a 
                  href="https://www.instagram.com/p/C9NkfzfyC6U/?utm_source=ig_embed&utm_campaign=loading" 
                  style={{
                    color: '#c9c8cd',
                    fontFamily: 'Arial,sans-serif',
                    fontSize: '14px',
                  ...
                  target="_blank"
                >
                  A post shared by Kaushik Srivatsan (@sk_tryingdesign)
                </a>
              </blockquote>
            </div>
          </div>
...
function CreativeCard({ creative }: { creative: Creative }) {
  const imageUrl = creative.image ? `/creatives/${creative.image}` : creative.cover;
  ...
  return (
    <Card className="group hover:shadow-xl transition-all duration-300 overflow-hidden">
      ...
      <CardContent className="p-4">
        ...
        <h3 className="font-sans font-semibold text-lg mb-2 group-hover:text-primary transition-colors line-clamp-2">
